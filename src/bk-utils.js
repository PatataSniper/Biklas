...
export function llamadaAjax(controlador, funcion, params, initOptions = null) {
    ...
    return llamadaAjaxAURL(new URL(`${controlador}/${funcion}`, ClientConfig.URL_API_BASE), params, initOptions);
}
        ...
        try {
            switch (responseBodyType) {
                ...
                case "arraybuffer":
                    ...
                    break;
                default:
                    throw `Tipo de cuerpo de respuesta '${responseBodyType}' no configurado. 
